...
#define TRAINING_SAMPLES 1210      //Number of samples in training dataset
#define ATTRIBUTES 400    	//Size of HOG descriptors vector as computed
#define TEST_SAMPLES 240    //Number of samples in test dataset
#define CLASSES 22
...
int main( int argc, char** argv )
{
    ...
    read_dataset("/home/cube26/shruti/shapes/traindata/a/trainingset.txt", training_set, training_set_classifications, TRAINING_SAMPLES);
    read_dataset("/home/cube26/shruti/shapes/traindata/a/testset.txt", test_set, test_set_classifications, TEST_SAMPLES);
        ...
        layers.at<int>(1,0)=20;//hidden layer
	...
	//t = ((double)cv::getTickCount() - t)/getTickFrequency(); 
        ...
        CvFileStorage* storage = cvOpenFileStorage( "/home/cube26/shruti/shapes/traindata/a/a_param.xml", 0, CV_STORAGE_WRITE );
        nnetwork.write(storage,"SignDetect");
        ...
        for (int tsample = 0; tsample < TEST_SAMPLES; tsample++) {
            ...
            printf("Testing Sample %i -> class result (sign %d)\n", tsample, sign);
