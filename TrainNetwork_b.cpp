...
#define TRAINING_SAMPLES 988      //Number of samples in training dataset
#define ATTRIBUTES 400   	//Size of HOG descriptors vector as computed
#define TEST_SAMPLES 202     //Number of samples in test dataset
#define CLASSES 27
...
int main( int argc, char** argv )
{
    ...
    read_dataset("/home/cube26/shruti/shapes/traindata/b/trainingset.txt", training_set, training_set_classifications, TRAINING_SAMPLES);
    read_dataset("/home/cube26/shruti/shapes/traindata/b/testset.txt", test_set, test_set_classifications, TEST_SAMPLES);
	...
	//t = ((double)cv::getTickCount() - t)/getTickFrequency(); 
        ...
        CvFileStorage* storage = cvOpenFileStorage( "/home/cube26/shruti/shapes/traindata/b/b_param.xml", 0, CV_STORAGE_WRITE );
