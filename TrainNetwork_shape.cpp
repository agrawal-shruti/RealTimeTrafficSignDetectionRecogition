...
//#define TRAINING_SAMPLES 2440       //Number of samples in training dataset
#define TRAINING_SAMPLES 2598       //Number of samples in training dataset (inc sign d)
#define ATTRIBUTES 900    	//Size of HogDescriptor
//#define TEST_SAMPLES 530      //Number of samples in test dataset
#define TEST_SAMPLES 551      //Number of samples in test dataset (inc sign d)
     ...
     for(int col = 0; col <=ATTRIBUTES; col++)
        {
            ...
            if (col < ATTRIBUTES){
                ...
                classes.at<float>(row,column) = 1.0;
 		cout<<"\nrow: "<<row<<" col: "<<label<<column;
            }
        }
    }
...
int main( int argc, char** argv )
{
    ...
    read_dataset("/home/cube26/shruti/shapes/trainingset.txt", training_set, training_set_classifications, TRAINING_SAMPLES);
    read_dataset("/home/cube26/shruti/shapes/testset.txt", test_set, test_set_classifications, TEST_SAMPLES);
        ...
        CvANN_MLP_TrainParams params(                                  
                                        ...
                                        cvTermCriteria(CV_TERMCRIT_ITER+CV_TERMCRIT_EPS, 3850, 0.000001),
	   ...
	   //double t = (double)cv::getTickCount(); //start clock to compute training time
	   ...
	   //t = ((double)cv::getTickCount() - t)/getTickFrequency(); 
        ...
        CvFileStorage* storage = cvOpenFileStorage( "/home/cube26/shruti/shapes/param.xml", 0, CV_STORAGE_WRITE );
        nnetwork.write(storage,"FindShape");
        ...
        for (int tsample = 0; tsample < TEST_SAMPLES; tsample++) 
        {
            ...
            printf("Testing Sample %i -> class result (shape %c)\n", tsample, sign);
